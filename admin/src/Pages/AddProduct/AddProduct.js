...
import useAddProductForms from '../../Hooks/useAddProductForms';
    ...
    return (
        <div className='add-product-section'>
            ...
            <div className='add-product-container'>
                <h1 className='page-header'>Add Product to VALENCE-AM DB</h1>
                    ...
                    <div className='add-product-form-items form-one'>
                        ...
                        <div className='add-product-form-items-pair'>
                            <div className="form-input-lable-pair">
                                ...
                                <input type="text" name="product_id" value={basicData.product_id} onChange={handleBasicDataChange} />
                                {basicDataError.product_id && <p className="err-msg-validation">*{basicDataError.product_id}</p>}
                            </div>
                            <div className="form-input-lable-pair">
