    ...
    <body>
        <div class="email-container">
            ...
            <div class="content-container">
                <p><b>Application No: ${ticketDetails.ticket_id}</b></p>
                
                <p>Hi ${ticketDetails.name},</p>
                <p>Thank you for your interest in partnering with us.</p>
                <p>Here are your recorded details:</p>

                <p><b>Company Name: </b>${ticketDetails.company_name}</p>
                <p><b>Company Website: </b>${ticketDetails.company_website}</p>
                <p><b>Phone: </b>${ticketDetails.phone}</p>
                <p><b>Message: </b>${ticketDetails.message}</p>
                <p>Your application has been received and we will review it to ensure it aligns with our 'House of Composite
                    Consumables' vision. If it does, our team will contact you to plan the next steps.</p>
...
export { sendBASEmailToUser as sendBecomeASupplierUserEmail }